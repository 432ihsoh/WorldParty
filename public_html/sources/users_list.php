...
function deljob(){
	...
	if($_POST['param'] > 0){
		$chenge->delete(false,"users","user_id=" . $_POST['param']);
	}
}
...
<a href="users_detail.php?mid={$rows[$key]['user_id']}{$urlparam}">{$rows[$key]['last_name']}</a>
</td>
...
<p><a href="users_detail.php">新規</a></p>
